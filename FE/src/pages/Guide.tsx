    ...
    <div className="bg-surface min-h-screen py-16 text-ink relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-extrabold text-ink mb-4">Hướng dẫn sử dụng</h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, idx) => (
            <motion.div 
              ...
              key={idx} 
              className="text-center p-6 bg-white border border-slate-200 rounded-2xl hover:border-slate-300 hover:shadow-md transition-all shadow-sm"
            >
              <div className="w-16 h-16 mx-auto bg-primary-50 border border-primary-200 rounded-full flex items-center justify-center shadow-sm mb-6 text-primary-500">
                {step.icon}
              </div>
